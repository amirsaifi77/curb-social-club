...
| Session prompts | `docs/sessions.md` (preamble, template, Phase 0 sessions 0.1 to 0.10, Phase 1 sessions 1.1 to 1.17). Phase 0 is merged; Phase 1 sessions 1.1 (host migration and models) and 1.2 (materializer, nightly job, describer) are done, next is 1.3 (geo queries and list and map endpoints) |
