...
| Session prompts | `docs/sessions.md` (preamble, template, Phase 0 sessions 0.1 to 0.10, Phase 1 sessions 1.1 to 1.17). Phase 0 is merged; Phase 1 starts with 1.1 (host migration and models: venues, events, occurrences, clubs, sponsors, claim requests, Active Storage tables, `config/features.yml`) |
